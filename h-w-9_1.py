...
def proceed():
    ...
    try:
        ...
        print('Name should be spelled correctly')
...
def add_func(user_input, user_dict):
    ...
    print(f'Added to list: {user_name.title()}, {user_phone_numb}')
...
def change_function(user_input, user_dict):
    ...
    user_phone_numb = user_input[2]
    user_dict[user_name] = user_phone_numb
    print(f'User: {user_name.title()} number changed to: {user_phone_numb}')
    return user_name, user_phone_numb

def phone_function(user_input, user_dict):
    user_name = user_input[1].lower()
    user_phone_number = user_dict[user_name]
    print(f'User:{user_name.title()}, Phone number: {user_phone_number}')
